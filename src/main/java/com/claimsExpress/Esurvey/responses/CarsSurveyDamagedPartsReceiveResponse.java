...
public class CarsSurveyDamagedPartsReceiveResponse {
	...
	private String surveyDamagedPartDescription;

	private String surveyDamagedPartArabicDescription;
	...
	public String getSurveyDamagedPartDescription() {
		return surveyDamagedPartDescription;
	}



	public void setSurveyDamagedPartDescription(String surveyDamagedPartDescription) {
		this.surveyDamagedPartDescription = surveyDamagedPartDescription;
	}



	public String getSurveyDamagedPartArabicDescription() {
		return surveyDamagedPartArabicDescription;
	}



	public void setSurveyDamagedPartArabicDescription(String surveyDamagedPartArabicDescription) {
		this.surveyDamagedPartArabicDescription = surveyDamagedPartArabicDescription;
	}
